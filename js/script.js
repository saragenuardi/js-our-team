...
const memberTeams = document.querySelector(".team-container"); //-->Crea un elemento DIV per HTML dando una classe CSS denominata "team-container" 
...
btnAdd.addEventListener("click", function () {
  ...
  const addPhoto = document.getElementById("image").value;
